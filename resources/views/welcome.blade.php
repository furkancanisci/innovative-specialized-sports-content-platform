...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <main>
    <article>
      ...
      <section class="hero">
        <figure style="width:1550px;" class="card-banner">
          <img src="./assets/images/Ekran görüntüsü 2025-01-22 230501.png" alt="The Northman movie poster">
        </figure>
        <div class="container">
          ...
          <div class="hero-content">
            ...
            Support Team, <br><strong>Content of football</strong>, <br>Match Stories, More.
            </h1>
            ...
            <div class="meta-wrapper">
              ...
              <div class="date-time">
                ...
                <div>
                  ...
                  <time datetime="PT128M">28 min</time>
                </div>
