    ...
    <article>
      ...
      <section class="tv-series">
        <div class="container">
          ...
          <h2 class="h2 section-title">Best Training Videos</h2>
          ...
          <ul class="movies-list">
              ...
              <div class="movie-card">
                ...
                <a href="./movie-details.html">
                  <figure class="card-banner">
                    <img src="./assets/images/image.png" alt="Moon Knight movie poster">
                  </figure>
                </a>
            ...
            <li>
              <div class="movie-card">
                ...
                <a href="./movie-details.html">
                  <figure class="card-banner">
                    <img src="./assets/images/image.png" alt="Halo movie poster">
                  </figure>
                </a>
            ...
            <li>
              <div class="movie-card">
                ...
                <a href="./movie-details.html">
                  <figure class="card-banner">
                    <img src="./assets/images/image.png" alt="Vikings: Valhalla movie poster">
                  </figure>
                </a>
            ...
            <li>
              <div class="movie-card">
                ...
                <a href="./movie-details.html">
                  <figure class="card-banner">
                    <img src="./assets/images/image.png" alt="Money Heist movie poster">
                  </figure>
                </a>
